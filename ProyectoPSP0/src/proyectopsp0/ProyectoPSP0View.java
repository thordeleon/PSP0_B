 ...
 */
public class ProyectoPSP0View extends FrameView {
    
    public ProyectoPSP0View(SingleFrameApplication app) {
        super(app);
    ...
    public void newRecord() {
        proyectopsp0.Clientes c = new proyectopsp0.Clientes();
    ...
    public void deleteRecord() {
        ...
        List<proyectopsp0.Clientes> toRemove = new ArrayList<proyectopsp0.Clientes>(selected.length);
        for (int idx=0; idx<selected.length; idx++) {
            proyectopsp0.Clientes c = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(c);
    ...
    private class SaveTask extends Task {
        ...
        @Override protected Void doInBackground() {
            try {
                ...
                rex.printStackTrace();
                entityManager.getTransaction().begin();
                List<proyectopsp0.Clientes> merged = new ArrayList<proyectopsp0.Clientes>(list.size());
                for (proyectopsp0.Clientes c : list) {
    ...
    public void showAboutBox() {
        if (aboutBox == null) {
            JFrame mainFrame = ProyectoPSP0App.getApplication().getMainFrame();
            aboutBox = new ProyectoPSP0AboutBox(mainFrame);
            aboutBox.setLocationRelativeTo(mainFrame);
        }
        ProyectoPSP0App.getApplication().show(aboutBox);
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(proyectopsp0.ProyectoPSP0App.class).getContext().getResourceMap(ProyectoPSP0View.class);
        ...
        masterTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Nombre", "Apellidos", "Telefono", "Correo Electronico", "Categoria"
            }
        ) {
        ...
        columnBinding.setColumnClass(String.class);
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${categoriasidCategorias}"));
        columnBinding.setColumnName("Categoriasid Categorias");
        columnBinding.setColumnClass(Integer.class);
        ...
        categoriasidCategoriasLabel.setText(resourceMap.getString("categoriasidCategoriasLabel.text")); // NOI18N
        categoriasidCategoriasLabel.setName("categoriasidCategoriasLabel"); // NOI18N

        idField.setText(resourceMap.getString("idField.text")); // NOI18N
        idField.setDisabledTextColor(resourceMap.getColor("idField.disabledTextColor")); // NOI18N
        ...
        nombreField.setDisabledTextColor(resourceMap.getColor("nombreField.disabledTextColor")); // NOI18N
        ...
        apellidosField.setDisabledTextColor(resourceMap.getColor("nombreField.disabledTextColor")); // NOI18N
        ...
        telefonoField.setDisabledTextColor(resourceMap.getColor("nombreField.disabledTextColor")); // NOI18N
        ...
        correoElectronicoField.setDisabledTextColor(resourceMap.getColor("nombreField.disabledTextColor")); // NOI18N
        ...
        categoriasidCategoriasField.setDisabledTextColor(resourceMap.getColor("nombreField.disabledTextColor")); // NOI18N
        categoriasidCategoriasField.setName("categoriasidCategoriasField"); // NOI18N

        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.categoriasidCategorias}"), categoriasidCategoriasField, org.jdesktop.beansbinding.BeanProperty.create("text"));
        binding.setSourceUnreadableValue("null");
        bindingGroup.addBinding(binding);
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement != null}"), categoriasidCategoriasField, org.jdesktop.beansbinding.BeanProperty.create("enabled"));
        bindingGroup.addBinding(binding);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(proyectopsp0.ProyectoPSP0App.class).getContext().getActionMap(ProyectoPSP0View.class, this);
                        ...
                        .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(mainPanelLayout.createSequentialGroup()
                                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(categoriasidCategoriasLabel))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(idField, javax.swing.GroupLayout.DEFAULT_SIZE, 331, Short.MAX_VALUE)
                                    .addComponent(nombreField, javax.swing.GroupLayout.DEFAULT_SIZE, 331, Short.MAX_VALUE)
                                    ...
                                    .addComponent(correoElectronicoField, javax.swing.GroupLayout.DEFAULT_SIZE, 331, Short.MAX_VALUE)
                                    .addComponent(categoriasidCategoriasField, javax.swing.GroupLayout.DEFAULT_SIZE, 331, Short.MAX_VALUE)))
        ...
        mainPanelLayout.setVerticalGroup(
            ...
            .addGroup(mainPanelLayout.createSequentialGroup()
                ...
                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(categoriasidCategoriasLabel)
                    .addComponent(categoriasidCategoriasField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(saveButton)
                    .addComponent(refreshButton)
    ...
    private javax.swing.JTextField categoriasidCategoriasField;
    private javax.swing.JLabel categoriasidCategoriasLabel;
    ...
    private java.util.List<proyectopsp0.Clientes> list;
